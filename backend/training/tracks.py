"""훈련 유형 분류표 (T01~T08 / S01~S08).

시나리오 카드가 실제로 존재하는지와는 별개인 화면에 보여줄 목록으로,
훈련 가능 여부는 views 에서 Scenario 적재 현황과 조인해 available로 내려간다.

분류 코드는 시나리오 카드의 Scenario.track 과 같은 체계
"""
